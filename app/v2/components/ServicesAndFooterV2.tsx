      ...
      <div className="w-full max-w-[1440px] mx-auto border-x-0 sm:border-x-2 border-black bg-white flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 border-b-2 border-black bg-white">
          ...
          <motion.div
            ...
            className="md:col-span-7 lg:col-span-7 bg-[#FAED00] border-b-2 md:border-b-0 md:border-r-2 border-black p-6 sm:p-8 md:p-10 flex flex-col justify-between min-h-[380px] md:min-h-[440px] select-none relative overflow-hidden"
          >
              ...
              {activeService === null ? (
                ...
                >
                  <div>
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-black uppercase tracking-tight text-black leading-[0.98] font-mono mb-5">
                      ENGINEERING<br />PRODUCT<br />EXPERIENCES.
                    </h2>

                    <p className="text-xs sm:text-sm font-bold uppercase tracking-wider text-black/90 leading-relaxed max-w-lg mb-6 font-sans">
                      BRIDGING END-TO-END PRODUCT DESIGN, INTERACTION ARCHITECTURE, AND PRODUCTION-READY FRONTEND CODE FOR VENTURES &amp; ENTERPRISES.
                    </p>
                  </div>

                  <div className="pt-4 border-t-2 border-black/20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-6">
                    <div className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-black font-mono">
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="px-2.5 py-0.5 bg-black text-[#FAED00] font-mono text-[10px] font-black uppercase border border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                        ACTIVE SERVICE
                      </span>
                    </div>

                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tight text-black leading-[0.98] font-mono mb-2">
                      {activeService.num} // {activeService.title}
                    </h2>

                    <p className="text-xs sm:text-sm font-black uppercase tracking-wider text-black font-mono mb-3">
                      {activeService.subtitle}
                    </p>

                    <p className="text-xs font-bold uppercase tracking-wide text-black/85 leading-relaxed max-w-lg mb-6 font-sans">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="flex flex-wrap gap-2 sm:gap-2.5">
                        {activeService.tools.map((tool) => (
                          <span
                            key={tool}
                            className="px-3.5 py-1.5 bg-black text-white font-mono font-bold text-xs sm:text-sm uppercase tracking-wider border-2 border-black shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all select-none"
                          >
                            {tool}
                          </span>
                        ))}
                  ...
                  <div className="pt-4 border-t-2 border-black/20 flex items-center justify-between mt-6">
                    <div className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-black font-mono">
                      <span className="text-[#FF462D] font-bold">✦</span>
                      <span>{activeService.tools.length} CORE TOOLS &amp; SKILLS ACTIVE</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => setOpenIndex(null)}
                      className="text-[10px] font-mono font-black uppercase tracking-wider text-black hover:text-[#FF462D] transition-colors underline underline-offset-2 cursor-pointer"
                    >
                      [RESET OVERVIEW ×]
                    </button>
                  </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`w-full px-5 py-5 sm:px-6 sm:py-6 flex items-center justify-between text-left group min-h-[75px] sm:min-h-[88px] transition-all cursor-pointer select-none ${
                      isOpen
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`w-7 h-7 flex items-center justify-center shrink-0 border-2 transition-all ${
                        isOpen
